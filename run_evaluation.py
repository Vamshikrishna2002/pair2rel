...
from pair2rel.modules import utils
import gc
...
with open('/home/bt19d200/NER_Vamshi/Pair2Rel/data/all_wikidata_properties.json', 'r') as f:
...
id2rel.update(json.load(open('/home/bt19d200/NER_Vamshi/Pair2Rel/data/pid2name_fewrel.json')))
id2rel.update(json.load(open('/home/bt19d200/NER_Vamshi/Pair2Rel/data/pid2name_wiki.json')))
...
def load_test_set():
    with open('/home/bt19d200/NER_Vamshi/Pair2Rel/data/docred_test.jsonl', 'r') as f:
...
def load_model(checkpoint_dir):
    ...
    model = Pair2Rel.from_pretrained(checkpoint_dir).to(device)
    model.device = device
    return model
